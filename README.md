...
## Key Insights
- Hierarchical clustering produced stable clusters and was easier to interpret due to the dendrogram.  
...
- Selecting meaningful `eps` values for DBSCAN required trial and error because the dataset does not exhibit density-based clusters.  
...
## Inclded Files
- `main.ipynb` – Full implementation with explanations, visualizations, and metrics  
